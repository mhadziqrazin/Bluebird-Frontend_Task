  ...
  if (!car) {
    return (
      <main className='container mx-auto px-4 py-40 flex justify-center'>
        <h1 className='text-center font-medium text-primary text-xl'>
          No matched vehicle found
        </h1>
      </main>
    )
  }
        ...
        <div className='flex flex-col gap-4 p-4 sm:p-8 justify-between rounded-2xl bg-dark/10'>
          <div className='flex justify-between items-start'>
            <div>
              ...
              <p className='sm:text-xl text-primary/60'>
          ...
          <div className='flex justify-between items-center'>
            <p className='text-lg sm:text-2xl text-secondary font-semibold'>
              {car.price}
            </p>
            <BookButton car={car} />
          </div>
